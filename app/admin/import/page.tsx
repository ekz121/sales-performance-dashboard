    ...
    <div className="mx-auto max-w-6xl px-5 py-7">
      ...
      <section className="card mt-5 p-6">
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-2">
          <div className="rounded-xl border border-stone-200 p-4 text-xs leading-6 text-stone-600"><h3 className="font-bold text-stone-900">Actual penjualan — template atau MASTER</h3><p className="mt-1">Excel wajib memiliki sheet <strong>MASTER</strong> dengan header pada baris pertama. CSV langsung memakai header baris pertama. Data ini mengisi actual kategori, sales, brand, operator, racing, dan produk fokus.</p></div>
          <div className="rounded-xl border border-stone-200 p-4 text-xs leading-6 text-stone-600"><h3 className="font-bold text-stone-900">Target dashboard — workbook report</h3><p className="mt-1">Workbook report seperti M221 boleh langsung diunggah selama sheet <strong>MASTER</strong> dan <strong>TARGET</strong> tetap ada dengan layout aslinya. Jika hanya mengunggah MASTER, actual tetap tampil; target dapat diisi lewat menu <Link className="font-bold text-brand-600 underline" href="/admin/report-targets">Target</Link>.</p></div>
        </div>
