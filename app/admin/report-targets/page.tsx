...
export default function ReportTargetsPage() {
  ...
  return <main className="min-h-screen pb-12">
    <header className="border-b border-stone-200 bg-white"><div className="mx-auto flex max-w-[1500px] flex-wrap items-center justify-between gap-4 px-5 py-5"><div className="flex items-center gap-3"><span className="relative h-11 w-11 overflow-hidden rounded-xl"><Image src="/erafone.png" alt="Erafone" fill sizes="48px" className="object-cover" /></span><div><p className="text-xs font-black uppercase tracking-widest text-brand-600">Admin Analytics</p><h1 className="text-xl font-black">CRUD Target Dashboard</h1></div></div><div className="flex flex-wrap gap-2"><Link href="/admin/import" className="btn-secondary"><ArrowLeft size={15} /> Import</Link><Link href="/admin/transactions" className="btn-secondary">Transaksi</Link><Link href="/admin/racing" className="btn-secondary">Program Racing</Link><Link href="/dashboard" className="btn-primary">Dashboard</Link></div></div></header>
